...
#define DELAY_CS_TOGGLE_TICKS       5
//#define DELAY_AFTER_FUNC_TICKS      2
#define DELAY_AFTER_FUNC_TICKS      5
//#define DELAY_CE_HIGH_US            (20)
#define DELAY_CE_HIGH_US            (200)
//#define DELAY_CHANGE_PWR_MODE_US    (1500)
#define DELAY_CHANGE_PWR_MODE_US    (3000)
//#define DELAY_CHANGE_TXRX_US        (130)
#define DELAY_CHANGE_TXRX_US        (3500)
//#define DELAY_CE_START_US           (5)
#define DELAY_CE_START_US           (100)
/*
