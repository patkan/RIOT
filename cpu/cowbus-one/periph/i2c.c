...
static void _i2c_init(I2C_TypeDef *i2c, uint32_t presc, uint32_t scll,
                      ...
                      uint32_t timing);
static void _pin_config(gpio_t pin_scl, gpio_t pin_sda, gpio_af_t af);
...
int i2c_init_master(i2c_t dev, i2c_speed_t speed)
{
    ...
    switch (dev) {
        ...
        case I2C_0:
            i2c = I2C_0_DEV;
            pin_scl = GPIO(I2C_0_PORT, I2C_0_PIN_SCL);
            pin_sda = GPIO(I2C_0_PORT, I2C_0_PIN_SDA);
            af = I2C_0_PIN_AF;
            I2C_0_CLKEN();
            I2C_0_PORT_CLKEN();
            NVIC_SetPriority(I2C_0_IRQ, I2C_IRQ_PRIO);
        ...
        case I2C_1:
            i2c = I2C_1_DEV;
            pin_scl = GPIO(I2C_1_PORT, I2C_1_PIN_SCL);
            pin_sda = GPIO(I2C_1_PORT, I2C_1_PIN_SDA);
            af = I2C_1_PIN_AF;
            I2C_1_CLKEN();
            I2C_0_PORT_CLKEN();
            NVIC_SetPriority(I2C_1_IRQ, I2C_IRQ_PRIO);
            NVIC_EnableIRQ(I2C_1_IRQ);
            break;
#endif
    ...
    /* configure pins */
    _pin_config(pin_scl, pin_sda, af);
...
static void _pin_config(gpio_t scl, gpio_t sda, gpio_af_t af)
{
